...
export const Paragraph3 = () => {
  return (
    <div className="paragraph3">
      <Fade bottom>
        <div className="paragraph3-leftside">
          <div className="paragraph3-text">
            <div className="paragraph3-text__title">We Are Experienced</div>
        ...
        <div className="paragraph3-rightside">
          <div className="paragraph3-img"></div>
        </div>
      </Fade>
    </div>
  );
